...
public class ObsvAdd extends JDialog {
	...
	public ObsvAdd() {
			...
			btnSave.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						cp.AddObs(2,txtDesc.getText() ,new Date(),txtGeo.getText(), ((Fenomeno)cbxFen.getSelectedItem()).getIdFenomeno(), ((Localidad)cbxLoc.getSelectedItem()).getIdLoc(), 21);
		...
		btnActualizar.setBounds(315, 73, 127, 26);
		...
		public void UpFen() {
			...
			try {
				...
				fenl = cp.FGet();
				for (Fenomeno fenomeno : fenl) {
					cbxFen.addItem(fenomeno);
				}
		...
		private void UpLoc() {
			...
			for (Localidad localidad : locL) {
				cbxLoc.addItem(localidad);
			}
